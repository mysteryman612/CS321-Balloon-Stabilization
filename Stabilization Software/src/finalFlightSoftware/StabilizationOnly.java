...
public class StabilizationOnly {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			data = sensorConnect();// call sensor team for data
	...
	private double sensorConnect() {
		...
		InetAddress addr;
		try {
			// change address and socket later
		...
		try {
			...
			System.out.println("Bad data recieved, couldnt parse double");
			return -1;
		}
